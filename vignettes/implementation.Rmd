...
**===================================**\
**REMINDER**\
**ICDPICR Version 2.0.4 IS BEING TESTED**\
...
* **Program “iciss”**
Reads in user data in the specified format.  Returns two versions of the “ICD-based” Injury Severity Score (ICISS).  Further details about the available options are provided in the help file for this function.
