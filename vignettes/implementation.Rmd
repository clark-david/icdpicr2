...
**===================================**\
**REMINDER**\
**ICDPICR Version 2.0.2 IS BEING TESTED**\
...
Version 2 of “icdpicr”, named “icdpicr2”, is a further update in response to these studies and numerous other inquiries and suggestions.  Because of copyright restrictions, it continues to use only the original version of the Abbreviated Injury Score (AIS).[7]  
...
* Version 2 (“icdpicr2”) reports mechanism and intent categories following the most recent CDC publication.[11]  It adds the CDC framework for body area and nature of injury,[12] and calculates an approximate survival probability based on the empirical survival for each cell of the framework.[13]  It computes two versions (“multiplicative injury” and “worst injury”) of an “ICD-based Injury Severity Score” (ICISS).[8,14]   

* Version 2 (“icdpicr2”) has also been simplified in several ways so that it will run faster than previous versions. In particular, the extraction of injury mechanism codes has been made much more efficient, which greatly reduces the most time-consuming step in Version 1.
...
Programs icd10aisA, icd10aisB, icd10aisC, icd10aisD, and icd10aisE, and a modification of the table published by Gedeborg and colleagues[8] can be found at https://github.com/clark-david/icdpicr2/prelim/.
...
* **i10_map_iciss:**  This table is new in Version 2.  It uses the results of icd10aisD to assign ICD-10 injury codes to a 4-digit ICD-10 code and its associated survival probability as published by Gedeborg and colleagues.[8]

* **i10_map_frame:**  This table is new in Version 2.  It uses the results of icd10aisE to assign ICD-10 injury codes to a cell in the CDC “Framework for Presenting Injury Data”.[12]
...
* **Program “framework”**
Reads in user data in the specified format.  Assigns ICD-10 injury codes to a cell in the CDC “Framework for Presenting Injury Data”.[12]  Calculates a predicted survival for each case.  Further details about the available options are provided in the help file for this function.
...
14. Berecki_Gisolf J, Rezaei-Darzi E, Fernando DT, D’Elia A.  International Classification of Disease based Injury Severity Score (ICISS): a comparison of methodologies applied to linked data from New South Wales, Australia.  Inj Prev 2024; 0:1-8 ePub ahead of print.
