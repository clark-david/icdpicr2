...
* **i10_map_iciss:**  This table is new in Version 2.0.0.  It uses the results of icd10aisD to assign ICD-10 injury codes to a 4-digit ICD-10 code and its associated survival probability as published by Gedeborg and colleagues.[8]

* **i10_map_frame:**  This table is new in Version 2.0.0.  It uses the results of icd10aisE to assign ICD-10 injury codes to a cell in the “Framework for Presenting Injury Data” published by Hedegaard and colleagues.[13]
