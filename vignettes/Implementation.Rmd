...
Version 2.0.0 of “icdpicr”, named “icdpicr2”, is a further update in response to these studies and numerous other inquiries and suggestions.  Because of copyright restrictions, it continues to use only the original version of the Abbreviated Injury Score (AIS).[7]  The most important changes are as follows:
...
Programs used to derive severity scores for Version 2.0.0 (“icdpicr2”):
